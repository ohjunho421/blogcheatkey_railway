...
📚 자료 활용 가이드: 
- 위 연구 자료의 내용을 바탕으로 전문적인 정보를 제공하되, 자연스럽게 출처를 언급하세요
- "최근 연구에 따르면", "업계 보고서에서는", "전문 기관 조사 결과" 등의 표현 활용
...
📝 블로그 글 작성 요구사항:
- 일반 텍스트 형식으로 블로그 작성
- 서론 비중 확대: 전체 글의 25-30% (400-500자 정도)
...
✅ 연구 자료 인용 표현:
- "최근 연구에 따르면", "업계 보고서에서는", "전문 기관 조사 결과"
- "관련 연구 결과에 따르면", "조사 데이터를 보면", "전문가들은"
- "연구진이 발표한 자료에 따르면", "공식 통계에 의하면"
- 자연스럽게 연구 내용을 인용하여 전문성과 신뢰성 강화`;
