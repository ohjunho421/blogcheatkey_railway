...
- 키워드 형태소가 아닌 다른 모든 단어는 14회 미만으로 제한
- 키워드 형태소도 20회를 절대 초과하면 안됨
- 공백 제외 1700자 미만은 절대 안됨 (내용 부족)
- 공백 제외 2000자 초과도 절대 안됨 (너무 긺)

🔥 형태소 빈도 최종 제한 (절대 준수!) 🔥:
- 키워드 구성 형태소: 15-17회 권장, 최대 20회까지 허용
- 키워드가 아닌 모든 단어: 14회 미만으로 엄격히 제한 (최대 13회)
- 어떤 형태소든 21회 이상 사용 시 즉시 스팸 판정
- 자연스러운 문장을 위해 동의어와 유의어 적극 활용
