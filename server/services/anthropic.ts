...
- **작성 중 계속 글자수를 세면서 작성하세요. 1800-1900자를 목표로!**
- 서론(600-700자) + 본론(900-1100자) + 결론(200-300자) 구성
- 각 섹션을 작성할 때마다 글자수를 확인하세요
...
🎯 키워드 구성 단어 사용 (매우 중요!):
- 키워드를 의미 단위로 분해한 각 단어를 15-18회씩 사용 (16회 목표)
- **예시:**
  • "벤츠엔진경고등" = "벤츠" 16회 + "엔진" 16회 + "경고등" 16회
  • "냉각수부동액" = "냉각수" 16회 + "부동액" 16회  👈 각각 카운트!
  • "타이어교체비용" = "타이어" 16회 + "교체" 16회 + "비용" 16회
- **작성 중 각 단어를 쓸 때마다 "냉각수: 14회, 부동액: 13회..." 이렇게 세세요!**
