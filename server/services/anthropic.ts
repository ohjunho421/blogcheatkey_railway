...
- 키워드 형태소 각각 15-17회 정확히 사용
- 공백 제외 1500-1700자 범위 (반드시 준수!)
- 서론→본론(4소주제)→결론 구조
- 정보 전달형 블로그
...
- 공백 제외 1500-1700자 범위 엄수 (반드시 준수!)
- 서론-본론-결론 구조 유지

🚨 절대 금지 사항 (SEO 패널티 방지) 🚨:
- 어떤 형태소든 17회 초과 사용 절대 금지!
- 키워드 형태소가 아닌 다른 단어가 15회 이상 나오면 안됨!
- 완전한 키워드 "${keyword}" 정확히 5-7회만 사용
- 개별 구성 요소들 각각 정확히 15-17회만 사용
- 키워드 형태소가 글에서 가장 빈번한 단어여야 함
- 17회 초과하는 순간 검색 엔진에서 완전 제외됩니다
