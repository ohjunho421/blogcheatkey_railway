...
- 키워드를 이루는 각 단어(예: "벤츠", "엔진", "경고등")를 각각 15-17회씩 사용
- 키워드 구성 단어는 20회 초과 금지 (검색엔진 스팸)
- 키워드가 아닌 일반 단어는 13회까지만 사용
- 같은 단어 반복을 피하기 위해 동의어 사용 (예: "문제" → "이상", "결함", "고장")
...
• 키워드를 이루는 각 단어가 15-17회 범위를 벗어남
• 일반 단어가 키워드 구성 단어보다 많이 출현
• 공백 제외 1700-2000자 범위 벗어남
• 서론이 전체 글의 35% 미달
