...
💡 서론 패턴 선택 가이드:
- 데이터가 풍부할 때: 【통계 충격형】, 【뉴스 인용형】, 【전문가 견해형】, 【연구 발견형】 중 선택
- 독자 공감이 필요할 때: 【독자 고민 대변형】, 【실패 스토리형】, 【시간 압박형】 중 선택  
- 반전이나 신선함이 필요할 때: 【반전 스토리형】, 【비교 대조형】, 【호기심 자극형】 중 선택
- 성과나 변화를 강조할 때: 【극적 변화형】, 【성공 사례형】, 【미래 전망형】 중 선택

🎯 서론 작성 원칙:
1. 매번 완전히 다른 접근법으로 시작 (같은 패턴 연속 사용 금지)
2. 연구 자료에 실제 존재하는 내용을 기반으로 작성 
3. 키워드 특성에 맞는 가장 설득력 있는 패턴 선택
4. 독자가 끝까지 읽고 싶어지는 후킹 포인트 제공
