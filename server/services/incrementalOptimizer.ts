...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🚨 자연스러운 한국어 필수 규칙 (위반 시 실패!)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
형태소 빈도를 맞추더라도 단어가 깨지면 안 됩니다!

❌ 절대 금지 패턴:
   - 단어 중간이 잘린 표현: "크오일", "브레이제", "레이크"
   - 존재하지 않는 합성어: "브레이기", "크오일수", "주기수", "교체수"
   - 단어 끝에 의미 없는 글자 붙이기: "브레이수", "교체기"
   - 키워드 일부만 사용: "제동액" → "제동" + 아무단어

✅ 올바른 방법:
   - 완전한 단어만 사용: "브레이크", "오일", "교체", "주기"
   - 자연스러운 조사 연결: "브레이크의", "오일을", "교체를"
   - 정상적인 복합어: "브레이크오일", "교체주기", "제동액"

⚠️ 수정 완료 후 반드시 글 전체를 읽어보고
   의미가 통하지 않는 단어가 없는지 확인하세요!
...
⚠️ 절대 하지 말 것:
   ...
   - 새로운 소제목 추가 ❌
   - 서론/결론 수정 ❌
   - 단어를 깨뜨려서 의미 없는 단어 만들기 ❌ (예: "크오일", "브레이제" 등)

🚨 자연스러운 한국어 필수: 모든 단어가 실제 한국어 단어여야 합니다!
...
⚠️ 절대 하지 말 것:
   ...
   - 문장 삭제 ❌ (글자수 감소)
   - 키워드만 끼워넣기 ❌ (글자수 증가)
   - 단어를 억지로 쪼개거나 합쳐서 깨진 단어 만들기 ❌

🚨 자연스러운 한국어 필수 규칙:
   - "크오일", "브레이제", "브레이기" 같은 깨진 단어 절대 금지!
   - 반드시 완전한 단어만 사용 (예: "브레이크", "오일", "교체")
   - 존재하지 않는 단어 조합 금지 (예: "주기수", "교체수", "브레이수")
   - 수정 후 모든 단어가 실제 한국어인지 확인!
...
⚠️ 절대 하지 말 것:
   ...
   - 글자수 변경 ❌
   - 의미가 달라지는 치환 ❌
   - 단어를 깨뜨려서 의미 없는 단어 만들기 ❌

🚨 자연스러운 한국어 필수: 치환 후 모든 단어가 실제 한국어 단어여야 합니다!
   "크오일", "브레이제", "주기수" 같은 깨진 단어 절대 금지!
