...
🚨 **핵심 규칙:**
1. **한 줄은 한글 기준 20-23자 이내** (공백 포함)
2. **완전한 문장이면 한 줄로** (예: "꼭 기억해주세요." → 그대로 한 줄)
3. **긴 문장은 의미 단위로 분리** (예: 접속사, 쉼표 기준)
4. **단어/조사는 절대 분리 금지**

📝 **작업 방법:**
- 마침표(.)로 문장 구분 후, 각 문장이 23자 이하면 그대로 유지
- 23자 초과 문장만 접속사/쉼표 위치에서 자연스럽게 2-3줄로 분리
- 빈 줄(단락 구분)은 원본 그대로 유지
- 제목/소제목은 무조건 한 줄

✅ **올바른 예시:**
입력: "하지만 자칫 잘못된 정보나 생각없이 저렴한 제품만 쫓다가 생각지도 못한 문제가 생길 수 있어요. 그럴 때는 전문가의 도움을 받는 게 부담스러우시죠."

출력:
하지만 자칫 잘못된 정보나
생각없이 저렴한 제품만 쫓다가
생각지도 못한 문제가 생길 수 있어요.
그럴 때는 전문가의 도움을 받는 게 부담스러우시죠.
...
**이제 아래 텍스트를 위 규칙에 따라 정확히 포맷팅해주세요:**
