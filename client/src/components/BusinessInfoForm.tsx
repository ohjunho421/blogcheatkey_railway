  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        ...
        {/* Show additional sections after business info is saved */}
        {project.businessInfo && (
          <>
            {/* Custom Morphemes Section */}
            <div className="mt-8 pt-6 border-t">
              <div className="flex items-center mb-4">
                <Lightbulb className="h-5 w-5 text-primary mr-2" />
                <h3 className="text-lg font-semibold">추가 형태소 (선택사항)</h3>
              </div>
              ...
              <div className="space-y-4">
                ...
                <Button
                  onClick={() => saveCustomMorphemes.mutate(customMorphemes)}
            ...
            {(project.status === 'content_generation' || project.status === 'completed' || project.status === 'business_info') && (
              <div className="mt-8 pt-6 border-t">
                <div className="flex items-center mb-4">
                  <FileText className="h-5 w-5 text-primary mr-2" />
                  <h3 className="text-lg font-semibold">블로그 생성</h3>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  >
                    {generateContent.isPending ? (
                      ...
                      <>
                        <ArrowRight className="h-4 w-4 mr-2" />
                        {project.generatedContent ? '블로그 재생성' : 'SEO 블로그 생성하기'}
                      </>
                    )}
                  </Button>
                </div>
