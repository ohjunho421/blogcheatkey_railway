...
import { Building2, ArrowRight, Check, ChevronsUpDown, Save, RefreshCw, Lightbulb } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        ...
        {/* Additional Morphemes Section - Show after business info is saved */}
